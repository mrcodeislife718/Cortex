...
export class CortexCommercialRuntime {
  constructor({ oidc, sessions, stripe, webhookVerifier, repository, entitlements = new EntitlementService() } = {}) {
    ...
    this.oidc = oidc; this.sessions = sessions; this.stripe = stripe; this.webhookVerifier = webhookVerifier; this.repository = repository; this.entitlements = entitlements;
  }
